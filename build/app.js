...
Elm.Focus.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var update = F3(function (_p0,f,big) {
      var _p1 = _p0;
      return A2(_p1._0.update,f,big);
   });
   var set = F3(function (_p2,small,big) {
      var _p3 = _p2;
      return A2(_p3._0.update,$Basics.always(small),big);
   });
   var get = F2(function (_p4,big) {
      var _p5 = _p4;
      return _p5._0.get(big);
   });
   var Focus = function (a) {    return {ctor: "Focus",_0: a};};
   var create = F2(function (get,update) {
   ...
   _op["=>"] = F2(function (_p7,_p6) {
      ...
      var _p9 = _p6;
      var _p10 = _p9._0;
      var update = F2(function (f,big) {
         return A2(_p11.update,_p10.update(f),big);
      });
...
Elm.Highcharts = Elm.Highcharts || {};
Elm.Highcharts.ChartOptions = Elm.Highcharts.ChartOptions || {};
Elm.Highcharts.ChartOptions.make = function (_elm) {
   "use strict";
   _elm.Highcharts = _elm.Highcharts || {};
   _elm.Highcharts.ChartOptions = _elm.Highcharts.ChartOptions || {};
   if (_elm.Highcharts.ChartOptions.values)
   return _elm.Highcharts.ChartOptions.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var height = A2($Focus.create,
   function (_) {
      return _.height;
   },
   F2(function (f,r) {
      return _U.update(r,{height: f(r.height)});
   }));
   var defaultChartOptions = {width: 200
                             ,height: 200
                             ,dynamicResize: true};
   var ChartOptions = F3(function (a,b,c) {
      return {width: a,height: b,dynamicResize: c};
   });
   return _elm.Highcharts.ChartOptions.values = {_op: _op
                                                ,defaultChartOptions: defaultChartOptions
                                                ,height: height
                                                ,ChartOptions: ChartOptions};
};
Elm.Highcharts = Elm.Highcharts || {};
Elm.Highcharts.Pie = Elm.Highcharts.Pie || {};
Elm.Highcharts.Pie.make = function (_elm) {
   "use strict";
   _elm.Highcharts = _elm.Highcharts || {};
   _elm.Highcharts.Pie = _elm.Highcharts.Pie || {};
   if (_elm.Highcharts.Pie.values)
   return _elm.Highcharts.Pie.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var defaultOptions = {dataLabels: {enabled: false
                                     ,distance: -10}};
   var pie = F2(function (innerSize,data) {
      var makeData = function (_p0) {
         var _p1 = _p0;
         return {name: _p1._0,y: _p1._1};
      };
      return {innerSize: innerSize,data: A2($List.map,makeData,data)};
   });
   var DataLabel = F2(function (a,b) {
      return {enabled: a,distance: b};
   });
   var PlotOptions = function (a) {    return {dataLabels: a};};
   var PieData = F2(function (a,b) {    return {name: a,y: b};});
   var PieOptions = F2(function (a,b) {
      return {innerSize: a,data: b};
   });
   return _elm.Highcharts.Pie.values = {_op: _op
                                       ,defaultOptions: defaultOptions
                                       ,pie: pie
...
Elm.Highcharts = Elm.Highcharts || {};
Elm.Highcharts.make = function (_elm) {
   "use strict";
   _elm.Highcharts = _elm.Highcharts || {};
   if (_elm.Highcharts.values) return _elm.Highcharts.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Focus = Elm.Focus.make(_elm),
   $Highcharts$ChartOptions = Elm.Highcharts.ChartOptions.make(_elm),
   $Highcharts$Pie = Elm.Highcharts.Pie.make(_elm),
   $Html = Elm.Html.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Native$Highcharts = Elm.Native.Highcharts.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var chartOptions = A2($Focus.create,
   function (_) {
      return _.chartOptions;
   },
   F2(function (f,r) {
      return _U.update(r,{chartOptions: f(r.chartOptions)});
   }));
   var height = A2($Focus._op["=>"],
   chartOptions,
   $Highcharts$ChartOptions.height);
   var makeChart = F2(function (plotOptions,series) {
      return {chartOptions: $Highcharts$ChartOptions.defaultChartOptions
             ,tooltip: "{point.y}"
             ,plotOptions: _U.list([plotOptions])
             ,series: series};
   });
   var highchart = $Native$Highcharts.highchart;
   var PieOptions = function (a) {
      return {ctor: "PieOptions",_0: a};
   };
   var Pie = function (a) {    return {ctor: "Pie",_0: a};};
   var pie = F2(function (innerSize,data) {
      return A2(makeChart,
      PieOptions($Highcharts$Pie.defaultOptions),
      _U.list([Pie(A2($Highcharts$Pie.pie,innerSize,data))]));
   });
   var Chart = F4(function (a,b,c,d) {
      return {chartOptions: a,tooltip: b,plotOptions: c,series: d};
   });
   return _elm.Highcharts.values = {_op: _op
                                   ,highchart: highchart
                                   ,pie: pie
                                   ,height: height
                                   ,Chart: Chart};
...
Elm.Main.make = function (_elm) {
   ...
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Highcharts = Elm.Highcharts.make(_elm),
   $Html = Elm.Html.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([$Highcharts.highchart(A2($Highcharts.pie,
      40,
      model.data))]));
   });
   var Tick = function (a) {    return {ctor: "Tick",_0: a};};
   var update = F2(function (action,model) {
      ...
      if (_p0.ctor === "NoOp") {
            ...
            var _p2 = _p0._0;
            var newElapsed = function () {
               var _p1 = model.time;
               if (_p1.ctor === "Nothing") {
                     return 0;
                  } else {
                     return _p1._0._1 + (_p2 - _p1._0._0);
                  }
            }();
            var data = _U.cmp(newElapsed,
            3000) > 0 ? _U.list([{ctor: "_Tuple2",_0: "Oranges",_1: 12}
                                ,{ctor: "_Tuple2",_0: "Apples",_1: 8}
                                ,{ctor: "_Tuple2",_0: "Bananas",_1: 13}]) : model.data;
            return {ctor: "_Tuple2"
                   ,_0: _U.update(model,
                   {time: $Maybe.Just({ctor: "_Tuple2",_0: _p2,_1: newElapsed})
                   ,data: data})
   ...
   var init = {ctor: "_Tuple2"
              ,_0: {time: $Maybe.Nothing
                   ,data: _U.list([{ctor: "_Tuple2",_0: "Oranges",_1: 10}
                                  ,{ctor: "_Tuple2",_0: "Apples",_1: 15}
                                  ,{ctor: "_Tuple2",_0: "Bananas",_1: 8}])}
              ,_1: $Effects.tick(Tick)};
   ...
   app.tasks);
   var Model = F2(function (a,b) {    return {time: a,data: b};});
